...
Claude Code has a status line feature that sits below your prompt and displays live information. You configure it using the `/statusline` skill (I'll cover skills in a later entry). For example, here's what I ran:
